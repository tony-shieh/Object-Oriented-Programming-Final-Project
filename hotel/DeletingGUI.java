...
public class DeletingGUI extends JFrame{
  ...
  private static final String[] label = {"Room Deleting",
                                         "Name",
                                         "Tele",
                                         "Check In Date",
                                         "Check Out Date",
  ...
  private class ConfirmButtonHandler implements ActionListener{
    public void actionPerformed(ActionEvent e){
      ...
      try{
        ...
        if(Index.d.searching(h) != null){
          JOptionPane.showMessageDialog(null,Index.d.deleting(h));
        }
        else{
          JOptionPane.showMessageDialog(null,"Sorry, we didn't find your info!");
        }
      }
